...
/*Почему распечатает для всех Jerry?
Потому что по факту мы создали объект типа Jerry.
И потом записывали в различные переменные родительских типов,
но по факту он как был Jerry, так и оставался.
Тип объекта не меняется, он уже создан
 */
